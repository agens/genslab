...
//          return;
//        }
//				else if (data.substr(0,4) == 'goto') {
//          location = data.substr(5);
//        }
//        else if (data.substr(0,5) == 'clear') {
//        else if (data.substr(0,5) == 'raelc') {
//          terminal_clear();
...
//        else {
          ...
          terminal_input.get(0).scrollIntoView(true);
...
// andy >>
          //alert(data);
					if (data.substr(0,7) == '[array]') {
            var data_array = data.split("\n");
            data = data_array[1];
          }
          else if (data.substr(0,13) == '[destination]') {
            var data_array = data.split("\n");
            data = data_array[1]; // first line is reply
            dest = data_array[2]; // second line is destination
            $('#frm-redirect-new').attr('action', dest).get(0).submit();
          }
// << andy
